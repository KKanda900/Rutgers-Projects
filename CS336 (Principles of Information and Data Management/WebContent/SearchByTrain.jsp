...
<ul id= "navbarList">
	...
	try {
		...
		String str = String.format(
			"SELECT r.username, r.ReservationNumber, r.seatNumber, o.name, d.name,  TIME(so.deptDatetime), t.trainID, tl.transitLineName, " +
			...
			"r.totalFare from Reservation r, Station o, Station d, StopsAt so, StopsAt sd, TrainSchedule ts, TransitLine tl, Train t where " +
			"r.scheduleID = ts.scheduleID and ts.transitLineName = '%s' and ts.trainID = '%s' and ts.transitLineName = tl.transitLineName and ts.trainID = t.trainID and ts.scheduleID = so.scheduleID " +
			"and ts.scheduleID = sd.scheduleID and o.stationID = (select o.stationID from Station o where o.stationID = r.origin and o.stationID = so.stationID) and d.stationID = (select d.stationID from Station d where d.stationID = r.destination and d.stationID = sd.stationID)", transit, train);
				
		ResultSet result = stmt.executeQuery(str);
	%>
	<h2>
		<%
			out.print("The current reservations are:");
		%>
	</h2>
	<br>
