...
<ul id= "navbarList">
	...
	<%
		...
		String str = String.format("INSERT INTO Customer(username, password, emailAddress, firstName, lastName, address, state, zipCode, city, telephone) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')", username, pass, email, fName, lName, address, state, zip, city, phone);
		%>
		<p><%= str %></p><%
		...
		str = String.format("INSERT INTO Customer(username, password, emailAddress, firstName, lastName, address, state, zipCode, city, telephone) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')", username, pass, email, fName, lName, address, state, zip, city, phone);
		%>
		<p><%= str %></p><%
		stmt.execute(str);		
		conn.close();
